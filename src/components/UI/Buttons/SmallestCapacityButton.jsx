...
class SmallestCapacityButton extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      selected: true,
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (nextProps.deselectSmall) {
      return { type: "smallest", selected: false };
    }
    return null;
  }
  static propTypes = {
...
export default withStyles(styles)(SmallestCapacityButton);
